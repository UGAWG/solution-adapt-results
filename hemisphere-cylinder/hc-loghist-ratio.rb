...
rootlab=Array.new
rootlab<<['./sa-m06-a00-fun3d/hsc03','Lp Metric 30K']
rootlab<<['./sa-m06-a00-fun3d/hsc10','Lp Metric 100K']
rootlab<<['./sa-m06-a00-fun3d/epic/hsc03.epicICS','EPIC-ICS 30K']
rootlab<<['./sa-m06-a00-fun3d/epic/hsc10.epicICS','EPIC-ICS 100K']
rootlab<<['./sa-m06-a00-fun3d/epic/hsc03.epicICSM','EPIC-ICSM 30K']
...
File.open(lay,'w') do |f|
  ...
  f.printf axisdetail+"{RANGEMAX = 100.0}"+"\n"
  ...
  f.printf axisdetail+"{TITLE{OFFSET = 6}}"+"\n"
  f.printf axisdetail+"{COORDSCALE = LOG}"+"\n"
  f.printf axisdetail+"{RANGEMIN = 1.0e-5}"+"\n"
  f.printf axisdetail+"{RANGEMAX = 10.0}"+"\n"
